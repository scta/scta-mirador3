...
var _default = {
  ...
  theme: {
    ...
    palette: {
      ...
      darkened: {
        // custom colors used for a specific offset in some places
        dark: '#000000',
        light: '#eeeeee'
      },
      lightened: {
  ...
  // Configure if annotations to be displayed on the canvas by default when fetched
  ...
  windows: [],
  // Array of windows to be open when mirador initializes (each object should at least provide a loadedManifest key with the value of the IIIF presentation manifest to load)
  thumbnailNavigation: {
    defaultPosition: 'off',
